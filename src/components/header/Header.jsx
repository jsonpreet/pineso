                                            ...
                                            <div className="flex flex-row w-full items-center pt-2 px-4">
                                                {
                                                    recentSearch.map((search, index) => {
                                                        return (
                                                            <span key={search} className="font-semibold mr-2 bg-gray-200 px-4 py-1 rounded-full hover:bg-black hover:text-white duration-75 delay-75">{search}</span>
                                            ...
                                            <div className='grid grid-cols-5 gap-2 p-2 mb-4 w-full'>
                                                {feed?.length > 0 && feed.map((post, index) => {
                                                    if (post?.tag?.Hashtag === undefined) {
                                                        <a key='twitterTag' target="_blank" rel="noreferrer" href="https://twitter.com/AppPineso" style={{ backgroundImage: `url(/twitter.webp)`}} className={`bg-cover bg-no-repeat bg-center group relative flex flex-col items-center justify-center w-50 h-24 text-sm px-4 rounded-xl duration-75 delay-75 bg-black text-white hover:bg-[#5634ee]'} font-semibold shadow-xl`}>
